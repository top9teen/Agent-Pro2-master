...
) ENGINE=MyISAM AUTO_INCREMENT=999 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='อำเภอ';
...
) ENGINE=MyISAM AUTO_INCREMENT=8861 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตำบล';
...
CREATE TABLE IF NOT EXISTS `formregiter` (
  ...
  PRIMARY KEY (`fo_id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='ประวัติ';
...
INSERT INTO `formregiter` (`fo_id`, `fo_groupType`, `fo_carMake`, `fo_carMake2`, `fo_lessmoney`, `fo_lessyear`, `fo_typebank`, `fo_checkbox1`, `fo_checkbox2`, `fo_checkbox3`, `fo_checkbox4`, `fo_prefix`, `fo_fNameTH`, `fo_lNameTH`, `fo_birthDay`, `fo_birthMonth`, `fo_birthYear`, `fo_refID`, `fo_mobilePhone`, `fo_email`, `fo_availableTime`, `fo_job`, `fo_salary`, `fo_yearOfService`, `fo_monthOfService`, `fo_bureauPaidedStatusPaid`, `fo_propertyProjectName`, `fo_province`, `fo_amphur`, `fo_district`, `fo_Radio`, `fo_date`, `fo_reMonny`, `fo_us`) VALUES
	...
	(12, '2016', 'BENZ', 'A180 1.6 CGI URBAN (WDD176042)', '23,333.00', '2', 'ka1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', '', '', '', 'นาย', 'edsadadad', 'asdsadsadad', '01', 'กุมภาพันธ์', '2538', '1301500241933', '1234567890', 'topcupdata29902@gmail.com', '12.00-13.00 น.', 'ผู้มีรายได้หลักจากค่าคอมมิชชั่น', '323,123,213.00', '9', '5', 'ไม่เคย', 'กหฟกฟก', 'นนทบุรี   ', 'บางใหญ่   ', 'บางแม่นาง   ', '2', '2018-09-04', 23333, '1'),
	(13, '2016', 'FORD', 'FIESTA 1.0 ECOBOOT A/T5Dr  MNBSXXARJ8', '5,555.00', '1', 'ka1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', '', 'ปิดหนี้ธุรกิจ / SME / กิจการ / OD', '', 'นาย', 'fdsfdsf', 'sdfsdfsdf', '05', 'มิถุนายน', '2538', '1301500241933', '1234567890', 'topcupdata29902@gmail.com', '10.00-12.00 น.', 'ผู้มีรายได้หลักจากค่าคอมมิชชั่น', '33,333.00', '9', '4', 'ไม่เคย', 'กหฟกฟก', 'พระนครศรีอยุธยา   ', 'ผักไห่   ', 'ตาลาน   ', '2', '2018-09-04', 5555, '1');
...
) ENGINE=MyISAM AUTO_INCREMENT=78 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='จังหวัด';
...
CREATE TABLE IF NOT EXISTS `usertable` (
  ...
  PRIMARY KEY (`lo_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='member/admin';

-- Dumping data for table agentdb.usertable: ~7 rows (approximately)
/*!40000 ALTER TABLE `usertable` DISABLE KEYS */;
INSERT INTO `usertable` (`lo_id`, `lo_email`, `lo_password`, `lo_status`) VALUES
	(1, 'tt@tt', '1234', '2'),
	(2, 'dsad@sda', '12', '3'),
	(3, 'dasda@d.c', 'dasds', '2'),
	(4, 'top@top.com', '12345', '2'),
	(5, 'admin@admin.com', '1234', '1'),
	(6, 'topcupdata29902@gmail.com', 'facebook', '2'),
	(8, 'undefined', 'facebook', '2'),
	(9, 'kritkrai.rak@bru.ac.th', 'xxxx', '2');
