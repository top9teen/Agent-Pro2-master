...
-- Dumping structure for table agentdb.formmen
...
-- Dumping data for table agentdb.formmen: ~5 rows (approximately)
...
INSERT INTO `formmen` (`me_id`, `me_prefix2`, `me_fname2`, `me_lname2`, `me_birthDay2`, `me_birthMonth2`, `me_birthYear2`, `me_talaphone2`, `me_email2`, `me_job2`, `me_salary2`, `me_yearOfService2`, `me_monthOfService2`) VALUES
	(4, '2', 'eqewqeqwe', 'qweqweqwe', '25', '03', '2511', '2222222222', 'topcupdata29902@gmail.com', '9', '2,222,222.00', '14', '7'),
	(5, '2', 'wwww', 'wwww', '17', '06', '2528', '1001000000', 'wwew@ewqe.cc', '11', '2,222,222.00', '12', '6'),
	(6, '2', 'wqewqewqe', 'qwewqewq', '14', '03', '2527', '1001000000', 'sdsad@dsad.asdasd', '13', '22,323.00', '10', '6'),
	(7, '2', 'กหฟกฟกฟก', 'ฟกฟกฟกฟก', '15', '03', '2525', '2222222222', 'dsds@dasd.cc', '13', '500,000.00', '11', '5'),
	(8, 'นาย', 'dasdsad', 'asdsad', '15', 'เมษายน', '2528', '1001000000', 'wwew@ewqe.cc', 'ผู้มีรายได้หลักจากค่าคอมมิชชั่น', '22,222.00', '7', '7'),
	(9, 'นาย', 'dddd', 'dddd', '10', 'กรกฎาคม', '2533', '1001000000', 'rrrr@rrr.com', 'ผู้มีรายได้หลักจากค่าคอมมิชชั่น', '44,444.00', '6', '6'),
	(11, 'นางสาว', 'ewqeqweqwe', 'qweqwe', '13', 'มีนาคม', '2529', '1111111111', 'topcupdata29902@gmail.com', 'เจ้าของกิจการ', '2,323,123.00', '9', '5');
/*!40000 ALTER TABLE `formmen` ENABLE KEYS */;

-- Dumping structure for table agentdb.formregiter
CREATE TABLE IF NOT EXISTS `formregiter` (
  ...
  `fo_date` date NOT NULL COMMENT 'วันที่',
  `fo_reMonny` int(11) NOT NULL COMMENT 'ตัวคำนวนเงิน',
  `fo_us` varchar(1) NOT NULL COMMENT 'ตัสแบ่ง',
  PRIMARY KEY (`fo_id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='ประวัติ';

-- Dumping data for table agentdb.formregiter: ~8 rows (approximately)
...
INSERT INTO `formregiter` (`fo_id`, `fo_groupType`, `fo_carMake`, `fo_carMake2`, `fo_lessmoney`, `fo_lessyear`, `fo_typebank`, `fo_checkbox1`, `fo_checkbox2`, `fo_checkbox3`, `fo_checkbox4`, `fo_prefix`, `fo_fNameTH`, `fo_lNameTH`, `fo_birthDay`, `fo_birthMonth`, `fo_birthYear`, `fo_refID`, `fo_mobilePhone`, `fo_email`, `fo_availableTime`, `fo_job`, `fo_salary`, `fo_yearOfService`, `fo_monthOfService`, `fo_bureauPaidedStatusPaid`, `fo_propertyProjectName`, `fo_province`, `fo_amphur`, `fo_district`, `fo_Radio`, `fo_date`, `fo_reMonny`, `fo_us`) VALUES
	(1, '2016', 'BENZ', 'A250 AMG SPORT', '20,000.00', '4', 'ka1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', 'ปิดหนี้ธุรกิจ / SME / กิจการ / OD', 'dasdsadasd', 'นาง', 'toptan', 'rakmit', '02', '04', '2537', '1301500241933', '1234567890', 'topcupdata29902@gmail.com', '15.00-17.00 น.', '14', '5,000.00', '16', '6', '3', 'รรรร', '3', '59', '313', '2', '2018-08-13', 0, '1'),
	(2, '2017', 'FORD', 'FIESTA 1.5L A/T Trend 4DR (MNBAXXARJ)', '5,000.00', '2', 'ka1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', 'ปิดหนี้ธุรกิจ / SME / กิจการ / OD', 'wqewqewqewq', 'นางสาว', 'dasdsadsad', 'asdsadasd', '04', '04', '2538', '1301500241933', '1234567890', 'top@top.com', '13.00-15.00 น.', '11', '5,000.00', '12', '5', '3', 'กหฟกฟก', '4', '67', '370', '2', '2018-08-14', 0, '1'),
	(3, '2015', 'BMW', '118 I M Sport (F20) (MMFR540X05) B38B15A', '50,000.00', '3', 'sc1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', 'ปิดหนี้ธุรกิจ / SME / กิจการ / OD', '555weqeq', 'นางสาว', 'toptan', 'rakmit', '03', '04', '2538', '1301500241933', '1234567890', 'top@top.com', '12.00-13.00 น.', '12', '500,000.00', '10', '2', '3', 'กหฟกฟก', '2', '54', '273', '2', '2018-08-14', 0, '1'),
	(4, '2017', 'BMW', '328 I (F30)', '50,000.00', '3', 'sc1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', 'ปิดหนี้ธุรกิจ / SME / กิจการ / OD', 'weqeqe', 'นาง', 'ewqewqe', 'wewqewqe', '01', '05', '2535', '1301500241933', '1234567890', 'top@top.com', '13.00-15.00 น.', '10', '222,222.00', '13', '2', '3', 'กฟหกหฟกฟหกหฟ', '6', '91', '639', '1', '2018-08-14', 0, '1'),
	(5, '2015', 'BENZ', 'A180 AMG SPORT (WDD176042)', '2,222.00', '2', 'ka1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', '', '', 'นางสาว', 'sadasddsa', 'asdasdasd', '03', '01', '2538', '1301500241933', '1234567890', 'top@top.com', '10.00-12.00 น.', '15', '22,222.00', '11', '4', '3', 'รรรร', '3', '59', '313', '1', '2018-08-16', 0, '1'),
	(6, '2016', 'MAZDA', '2 SKYACTIVE 2XD High Plus (4DrMMSDL2S5DrMM8DJ2H)', '3,333.00', '1', 'kr1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', 'ปิดหนี้ธุรกิจ / SME / กิจการ / OD', '', 'นาง', 'ewqewqe', 'eqwewqe', '03', '03', '2539', '1301500241933', '1234567890', 'top@top.com', '12.00-13.00 น.', '11', '222,233.00', '12', '1', '3', 'กหฟกฟก', '3', '60', '323', '1', '2018-08-16', 0, '1'),
	(7, '2015', 'CHEVROLET', 'CAPTIVA 2.0 LTZ AWD (NAVI) (MMMCD26Y)', '323,223.00', '3', 'kr1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', 'ปิดหนี้ธุรกิจ / SME / กิจการ / OD', 'wwww', 'นาย', 'ewewewe', 'weqwqeqwe', '04', 'พฤษภาคม', '2536', '1301500241933', '1111111111', 'top@top.com', '12.00-13.00 น.', '13', '22,333.00', '10', '4', '3', 'ผแปแ', 'กรุงเทพมหานคร   ', 'เขตพระนคร   ', 'พระบรมมหาราชวัง', '1', '2018-08-17', 0, '1'),
	(8, '2016', 'BENZ', 'A250 2.0 CGI (WDD176044)', '22,222.00', '2', 'ka1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', '', '', 'นาย', 'dasdsad', 'asdsadsad', '03', 'มีนาคม', '2538', '1301500241933', '1234567890', 'top@top.com', '12.00-13.00 น.', 'อาชีพอิสระ(มี 50 ทวิ)', '22,222.00', '9', '4', 'ไม่เคย', 'กหฟกฟก', 'พระนครศรีอยุธยา   ', 'บางไทร   ', 'แคออก   ', '1', '2018-08-20', 22222, '1'),
	(9, '2015', 'BMW', '220 I COUPE MSPORT (WBA1J2080VW)', '44,444.00', '1', 'ka1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', '', '', 'นางสาว', 'ddd', 'ddd', '04', 'พฤษภาคม', '2536', '1301500241933', '1234567890', 'top@top.com', '10.00-12.00 น.', 'นักการเมือง', '3,333.00', '7', '4', 'ไม่เคย', 'กหฟกฟก', 'พระนครศรีอยุธยา   ', 'นครหลวง   ', 'บ้านชุ้ง   ', '1', '2018-08-23', 44444, '1'),
	(10, '2016', 'BMW', '1161 M Sport (MMF1A140)', '33,333.00', '1', 'ka1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', '', '', '', 'นาย', 'eeeee', 'dedede', '04', 'เมษายน', '2538', '1301500241933', '1234567890', 'top@top.com', '10.00-12.00 น.', 'พนักงานรัฐวิสาหกิจ', '33,333.00', '2', '3', 'ไม่เคย', 'กหฟกฟก', 'นนทบุรี   ', 'บางใหญ่   ', 'บางเลน   ', '2', '2018-08-27', 33333, '1'),
	(11, '2017', 'BMW', '330 E', '333.00', '1', 'ka1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', 'ปิดหนี้ธุรกิจ / SME / กิจการ / OD', '', 'นาง', 'qwewqeqw', 'eqweqweqwe', '04', 'มีนาคม', '2538', '1301500241933', '1234567890', 'top@top.com', '13.00-15.00 น.', 'พนักงานสัญญาจ้าง', '23,233.00', '10', '5', 'ไม่เคย', 'กหฟกฟก', 'นครราชสีมา   ', 'เสิงสาง   ', 'สุขไพบูลย์   ', '1', '2018-08-28', 333, '1');
...
-- Dumping structure for table agentdb.receipt
CREATE TABLE IF NOT EXISTS `receipt` (
  `re_id` int(11) NOT NULL AUTO_INCREMENT,
  `re_name` varchar(50) NOT NULL,
  `re_email` varchar(50) NOT NULL,
  `re_day` int(11) NOT NULL,
  `re_mont` varchar(50) NOT NULL,
  `re_year` int(11) NOT NULL,
  `re_monny` varchar(50) NOT NULL,
  `re_bank` varchar(50) NOT NULL,
  `re_admin` varchar(50) NOT NULL,
  `re_caryear` varchar(50) NOT NULL,
  `re_idGa` int(11) NOT NULL,
  `re_car` varchar(50) NOT NULL,
  `re_carmodel` varchar(255) NOT NULL,
  PRIMARY KEY (`re_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='ใบเสร็จ/ประวัติการจ่ายเงิน';

-- Dumping data for table agentdb.receipt: ~0 rows (approximately)
/*!40000 ALTER TABLE `receipt` DISABLE KEYS */;
INSERT INTO `receipt` (`re_id`, `re_name`, `re_email`, `re_day`, `re_mont`, `re_year`, `re_monny`, `re_bank`, `re_admin`, `re_caryear`, `re_idGa`, `re_car`, `re_carmodel`) VALUES
	(1, 'ddd        ddd', 'top@top.com', 29, 'สิงหาคม', 2561, '44444', 'กสิกร', 'แอดมินเว็บไซต์', '2015', 7, 'BMW', '220 I COUPE MSPORT (WBA1J2080VW)');
...
CREATE TABLE IF NOT EXISTS `usertable` (
  ...
  PRIMARY KEY (`lo_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='member/admin';

-- Dumping data for table agentdb.usertable: ~4 rows (approximately)
/*!40000 ALTER TABLE `usertable` DISABLE KEYS */;
INSERT INTO `usertable` (`lo_id`, `lo_email`, `lo_password`, `lo_status`) VALUES
	(1, 'tt@tt', '1234', '2'),
	(2, 'dsad@sda', '12', '3'),
	(3, 'dasda@d.c', 'dasds', '2'),
	(4, 'top@top.com', '1234', '2'),
	(5, 'admin@admin.com', '1234', '1');
...
-- Dumping structure for table agentdb.yearcar
CREATE TABLE IF NOT EXISTS `yearcar` (
  `yr_year` varchar(50) DEFAULT NULL,
  `yr_percent` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ปีแปลงเป็น เปอร์';

-- Dumping data for table agentdb.yearcar: ~5 rows (approximately)
/*!40000 ALTER TABLE `yearcar` DISABLE KEYS */;
INSERT INTO `yearcar` (`yr_year`, `yr_percent`) VALUES
	('1', '0.55'),
	('2', '0.55'),
	('3', '0.55'),
	('4', '0.60'),
	('5', '0.66');
/*!40000 ALTER TABLE `yearcar` ENABLE KEYS */;
...
-- Dumping data for table kasikorndb.formmen: ~2 rows (approximately)
/*!40000 ALTER TABLE `formmen` DISABLE KEYS */;
INSERT INTO `formmen` (`me_id`, `me_prefix2`, `me_fname2`, `me_lname2`, `me_birthDay2`, `me_birthMonth2`, `me_birthYear2`, `me_talaphone2`, `me_email2`, `me_job2`, `me_salary2`, `me_yearOfService2`, `me_monthOfService2`) VALUES
	(5, '2', 'wwww', 'wwww', '17', '06', '2528', '1001000000', 'wwew@ewqe.cc', '11', '2,222,222.00', '12', '6'),
	(6, 'นาย', 'dasdsad', 'asdsad', '15', 'เมษายน', '2528', '1001000000', 'wwew@ewqe.cc', 'ผู้มีรายได้หลักจากค่าคอมมิชชั่น', '22,222.00', '7', '7'),
	(7, 'นาย', 'dddd', 'dddd', '10', 'กรกฎาคม', '2533', '1001000000', 'rrrr@rrr.com', 'ผู้มีรายได้หลักจากค่าคอมมิชชั่น', '44,444.00', '6', '6'),
	(9, 'นางสาว', 'ewqeqweqwe', 'qweqwe', '13', 'มีนาคม', '2529', '1111111111', 'topcupdata29902@gmail.com', 'เจ้าของกิจการ', '2,323,123.00', '9', '5');
/*!40000 ALTER TABLE `formmen` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `formregiter` (
  ...
  `fo_reMonny` int(11) NOT NULL,
  PRIMARY KEY (`fo_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='ประวัติ';

-- Dumping data for table kasikorndb.formregiter: ~2 rows (approximately)
/*!40000 ALTER TABLE `formregiter` DISABLE KEYS */;
INSERT INTO `formregiter` (`fo_id`, `fo_groupType`, `fo_carMake`, `fo_carMake2`, `fo_lessmoney`, `fo_lessyear`, `fo_typebank`, `fo_checkbox1`, `fo_checkbox2`, `fo_checkbox3`, `fo_checkbox4`, `fo_prefix`, `fo_fNameTH`, `fo_lNameTH`, `fo_birthDay`, `fo_birthMonth`, `fo_birthYear`, `fo_refID`, `fo_mobilePhone`, `fo_email`, `fo_availableTime`, `fo_job`, `fo_salary`, `fo_yearOfService`, `fo_monthOfService`, `fo_bureauPaidedStatusPaid`, `fo_propertyProjectName`, `fo_province`, `fo_amphur`, `fo_district`, `fo_Radio`, `fo_date`, `fo_reMonny`) VALUES
	(5, '2015', 'BENZ', 'A180 AMG SPORT (WDD176042)', '2,222.00', '2', '5', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', '', '', '2', 'sadasddsa', 'asdasdasd', '03', '01', '2538', '1301500241933', '1234567890', 'top@top.com', '10.00-12.00 น.', '15', '22,222.00', '11', '4', '3', 'รรรร', '3', '59', '313', '1', '2018-08-16', 22222),
	(6, '2016', 'BENZ', 'A250 2.0 CGI (WDD176044)', '22,222.00', '2', '8', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', '', '', 'นาย', 'dasdsad', 'asdsadsad', '03', 'มีนาคม', '2538', '1301500241933', '1234567890', 'top@top.com', '12.00-13.00 น.', 'อาชีพอิสระ(มี 50 ทวิ)', '22,222.00', '9', '4', 'ไม่เคย', 'กหฟกฟก', 'พระนครศรีอยุธยา   ', 'บางไทร   ', 'แคออก   ', '1', '2018-08-20', 22222),
	(7, '2015', 'BMW', '220 I COUPE MSPORT (WBA1J2080VW)', '44,444.00', '1', '9', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', '', '', 'นางสาว', 'ddd', 'ddd', '04', 'พฤษภาคม', '2536', '1301500241933', '1234567890', 'top@top.com', '10.00-12.00 น.', 'นักการเมือง', '3,333.00', '7', '4', 'ไม่เคย', 'กหฟกฟก', 'พระนครศรีอยุธยา   ', 'นครหลวง   ', 'บ้านชุ้ง   ', '1', '2018-08-23', 44444),
	(8, '2016', 'BMW', '1161 M Sport (MMF1A140)', '33,333.00', '1', '0', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', '', '', '', 'นาย', 'eeeee', 'dedede', '04', 'เมษายน', '2538', '1301500241933', '1234567890', 'top@top.com', '10.00-12.00 น.', 'พนักงานรัฐวิสาหกิจ', '33,333.00', '2', '3', 'ไม่เคย', 'กหฟกฟก', 'นนทบุรี   ', 'บางใหญ่   ', 'บางเลน   ', '2', '2018-08-27', 33333),
	(9, '2017', 'BMW', '330 E', '333.00', '1', '11', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', 'ปิดหนี้ธุรกิจ / SME / กิจการ / OD', '', 'นาง', 'qwewqeqw', 'eqweqweqwe', '04', 'มีนาคม', '2538', '1301500241933', '1234567890', 'top@top.com', '13.00-15.00 น.', 'พนักงานสัญญาจ้าง', '23,233.00', '10', '5', 'ไม่เคย', 'กหฟกฟก', 'นครราชสีมา   ', 'เสิงสาง   ', 'สุขไพบูลย์   ', '1', '2018-08-28', 333);
/*!40000 ALTER TABLE `formregiter` ENABLE KEYS */;

-- Dumping structure for table kasikorndb.gather
CREATE TABLE IF NOT EXISTS `gather` (
  `ga_id` int(11) NOT NULL COMMENT 'iduser',
  `ga_name` varchar(50) NOT NULL COMMENT 'ชื่อ',
  `ga_car` varchar(50) NOT NULL COMMENT 'ยี่ห่อรถ',
  `ga_email` varchar(50) NOT NULL COMMENT 'email',
  `ga_prie` int(11) NOT NULL COMMENT 'เงินที่ต้องจ่าย',
  `ga_fistPeriod` int(11) NOT NULL COMMENT 'งวดทั้งหมด',
  `ga_lastPeriod` int(11) NOT NULL COMMENT 'งวดที่เหลือ',
  `ga_day` int(11) NOT NULL COMMENT 'วัดที่จ่าย',
  `ga_mont` int(11) NOT NULL COMMENT 'เดือนที่ต้องจ่าย',
  `ga_year` int(11) NOT NULL COMMENT 'ปี',
  `ga_user` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='รวบรวม';

-- Dumping data for table kasikorndb.gather: ~3 rows (approximately)
/*!40000 ALTER TABLE `gather` DISABLE KEYS */;
INSERT INTO `gather` (`ga_id`, `ga_name`, `ga_car`, `ga_email`, `ga_prie`, `ga_fistPeriod`, `ga_lastPeriod`, `ga_day`, `ga_mont`, `ga_year`, `ga_user`) VALUES
	(7, 'ddd', '220 I COUPE MSPORT (WBA1J2080VW)', 'top@top.com', 44444, 10, 12, 5, 9, 2561, 9),
	(6, 'dasdsad', 'A250 2.0 CGI (WDD176044)', 'top@top.com', 22222, 22, 24, 5, 8, 2561, 8),
	(5, 'sadasddsa', 'A180 AMG SPORT (WDD176042)', 'top@top.com', 22222, 22, 24, 5, 8, 2561, 5);
...
-- Dumping data for table krungsridb.formmen: ~0 rows (approximately)
/*!40000 ALTER TABLE `formmen` DISABLE KEYS */;
INSERT INTO `formmen` (`me_id`, `me_prefix2`, `me_fname2`, `me_lname2`, `me_birthDay2`, `me_birthMonth2`, `me_birthYear2`, `me_talaphone2`, `me_email2`, `me_job2`, `me_salary2`, `me_yearOfService2`, `me_monthOfService2`) VALUES
...
-- Dumping data for table krungsridb.formregiter: ~0 rows (approximately)
/*!40000 ALTER TABLE `formregiter` DISABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `formregiter` (
  ...
  `fo_date` date NOT NULL,
  PRIMARY KEY (`fo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ประวัติ';
