...
-- Dumping data for table agentdb.formmen: ~0 rows (approximately)
...
-- Dumping data for table agentdb.formregiter: ~3 rows (approximately)
...
INSERT INTO `formregiter` (`fo_id`, `fo_groupType`, `fo_carMake`, `fo_carMake2`, `fo_lessmoney`, `fo_lessyear`, `fo_typebank`, `fo_checkbox1`, `fo_checkbox2`, `fo_checkbox3`, `fo_checkbox4`, `fo_prefix`, `fo_fNameTH`, `fo_lNameTH`, `fo_birthDay`, `fo_birthMonth`, `fo_birthYear`, `fo_refID`, `fo_mobilePhone`, `fo_email`, `fo_availableTime`, `fo_job`, `fo_salary`, `fo_yearOfService`, `fo_monthOfService`, `fo_bureauPaidedStatusPaid`, `fo_propertyProjectName`, `fo_province`, `fo_amphur`, `fo_district`, `fo_Radio`, `fo_date`) VALUES
	(1, '2016', 'BENZ', 'A250 AMG SPORT', '20,000.00', '4', 'ka1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', 'ปิดหนี้ธุรกิจ / SME / กิจการ / OD', 'dasdsadasd', '3', 'toptan', 'rakmit', '02', '04', '2537', '1301500241933', '1234567890', 'topcupdata29902@gmail.com', '15.00-17.00 น.', '14', '5,000.00', '16', '6', '3', 'รรรร', '3', '59', '313', '2', '2018-08-13'),
	(2, '2017', 'FORD', 'FIESTA 1.5L A/T Trend 4DR (MNBAXXARJ)', '5,000.00', '2', 'ka1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', 'ปิดหนี้ธุรกิจ / SME / กิจการ / OD', 'wqewqewqewq', '2', 'dasdsadsad', 'asdsadasd', '04', '04', '2538', '1301500241933', '1234567890', 'top@top.com', '13.00-15.00 น.', '11', '5,000.00', '12', '5', '3', 'กหฟกฟก', '4', '67', '370', '1', '2018-08-14'),
	(3, '2015', 'BMW', '118 I M Sport (F20) (MMFR540X05) B38B15A', '50,000.00', '3', 'sc1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', 'ปิดหนี้ธุรกิจ / SME / กิจการ / OD', '555weqeq', '2', 'toptan', 'rakmit', '03', '04', '2538', '1301500241933', '1234567890', 'top@top.com', '12.00-13.00 น.', '12', '500,000.00', '10', '2', '3', 'กหฟกฟก', '2', '54', '273', '1', '2018-08-14'),
	(4, '2017', 'BMW', '328 I (F30)', '50,000.00', '3', 'sc1', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', 'ปิดหนี้ธุรกิจ / SME / กิจการ / OD', 'weqeqe', '3', 'ewqewqe', 'wewqewqe', '01', '05', '2535', '1301500241933', '1234567890', 'top@top.com', '13.00-15.00 น.', '10', '222,222.00', '13', '2', '3', 'กฟหกหฟกฟหกหฟ', '6', '91', '639', '1', '2018-08-14'),
...
-- Dumping data for table agentdb.yearcar: ~4 rows (approximately)
