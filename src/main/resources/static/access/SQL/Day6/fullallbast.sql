...
CREATE TABLE IF NOT EXISTS `receipt` (
  ...
  PRIMARY KEY (`re_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ใบเสร็จ/ประวัติการจ่ายเงิน';
...
CREATE TABLE IF NOT EXISTS `usertable` (
  ...
  PRIMARY KEY (`lo_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='member/admin';
...
INSERT INTO `gather` (`ga_id`, `ga_name`, `ga_car`, `ga_email`, `ga_prie`, `ga_fistPeriod`, `ga_lastPeriod`, `ga_day`, `ga_mont`, `ga_year`, `ga_user`) VALUES
	(7, 'ddd', '220 I COUPE MSPORT (WBA1J2080VW)', 'top@top.com', 44444, 11, 12, 5, 9, 2561, 9),
	(6, 'dasdsad', 'A250 2.0 CGI (WDD176044)', 'top@top.com', 22222, 22, 24, 5, 9, 2561, 8),
	(5, 'sadasddsa', 'A180 AMG SPORT (WDD176042)', 'top@top.com', 22222, 24, 24, 5, 8, 2561, 5);
