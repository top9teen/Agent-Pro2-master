...
-- Dumping data for table agentdb.formmen: ~6 rows (approximately)
...
-- Dumping data for table agentdb.formregiter: ~9 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `receipt` (
  ...
  PRIMARY KEY (`re_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='ใบเสร็จ/ประวัติการจ่ายเงิน';

-- Dumping data for table agentdb.receipt: ~0 rows (approximately)
/*!40000 ALTER TABLE `receipt` DISABLE KEYS */;
INSERT INTO `receipt` (`re_id`, `re_name`, `re_email`, `re_day`, `re_mont`, `re_year`, `re_monny`, `re_bank`, `re_admin`, `re_idga`) VALUES
	(2, 'sadasddsa     asdasdasd', 'top@top.com', 25, 'สิงหาคม', 2561, '1059', 'กสิกร', 'แอดมินเว็บไซต์', 5);
...
-- Dumping data for table kasikorndb.formmen: ~3 rows (approximately)
/*!40000 ALTER TABLE `formmen` DISABLE KEYS */;
INSERT INTO `formmen` (`me_id`, `me_prefix2`, `me_fname2`, `me_lname2`, `me_birthDay2`, `me_birthMonth2`, `me_birthYear2`, `me_talaphone2`, `me_email2`, `me_job2`, `me_salary2`, `me_yearOfService2`, `me_monthOfService2`) VALUES
	(5, '2', 'wwww', 'wwww', '17', '06', '2528', '1001000000', 'wwew@ewqe.cc', '11', '2,222,222.00', '12', '6'),
...
CREATE TABLE IF NOT EXISTS `formregiter` (
  ...
  PRIMARY KEY (`fo_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='ประวัติ';

-- Dumping data for table kasikorndb.formregiter: ~3 rows (approximately)
/*!40000 ALTER TABLE `formregiter` DISABLE KEYS */;
INSERT INTO `formregiter` (`fo_id`, `fo_groupType`, `fo_carMake`, `fo_carMake2`, `fo_lessmoney`, `fo_lessyear`, `fo_typebank`, `fo_checkbox1`, `fo_checkbox2`, `fo_checkbox3`, `fo_checkbox4`, `fo_prefix`, `fo_fNameTH`, `fo_lNameTH`, `fo_birthDay`, `fo_birthMonth`, `fo_birthYear`, `fo_refID`, `fo_mobilePhone`, `fo_email`, `fo_availableTime`, `fo_job`, `fo_salary`, `fo_yearOfService`, `fo_monthOfService`, `fo_bureauPaidedStatusPaid`, `fo_propertyProjectName`, `fo_province`, `fo_amphur`, `fo_district`, `fo_Radio`, `fo_date`, `fo_reMonny`) VALUES
	(5, '2015', 'BENZ', 'A180 AMG SPORT (WDD176042)', '22,222.00', '2', '5', 'ปิดสินเชื่อสถาบันการเงินอื่น (เช่น บัตรเครดิต สินเชื่อบุคคล รถยนต์ บ้าน)', 'ปิดหนี้สินเชื่ออื่นๆที่ไม่ใช่สถาบันการเงิน (เช่น ขายฝาก / จำนองกับบุคคลภายนอก)', '', '', '2', 'sadasddsa', 'asdasdasd', '03', '01', '2538', '1301500241933', '1234567890', 'top@top.com', '10.00-12.00 น.', '15', '22,222.00', '11', '4', '3', 'รรรร', '3', '59', '313', '1', '2018-08-16', 22222),
...
INSERT INTO `gather` (`ga_id`, `ga_name`, `ga_car`, `ga_email`, `ga_prie`, `ga_fistPeriod`, `ga_lastPeriod`, `ga_day`, `ga_mont`, `ga_year`, `ga_user`) VALUES
	(5, 'sadasddsa', 'A180 AMG SPORT (WDD176042)', 'top@top.com', 1059, 22, 24, 5, 9, 2561, 5);
