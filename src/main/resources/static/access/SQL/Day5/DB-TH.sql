...
CREATE TABLE IF NOT EXISTS `formregiter` (
  ...
  PRIMARY KEY (`fo_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='ประวัติ';
...
CREATE TABLE IF NOT EXISTS `formregiter` (
  ...
  PRIMARY KEY (`fo_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='ประวัติ';
...
CREATE TABLE IF NOT EXISTS `gather` (
  ...
  `ga_car` varchar(50) DEFAULT NULL COMMENT 'ยี่ห่อรถ',
  ...
  `ga_mont` int(11) DEFAULT NULL COMMENT 'เดือนที่ต้องจ่าย',
  `ga_year` int(11) DEFAULT NULL COMMENT 'ปี'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='รวบรวม';

-- Dumping data for table kasikorndb.gather: ~1 rows (approximately)
/*!40000 ALTER TABLE `gather` DISABLE KEYS */;
INSERT INTO `gather` (`ga_id`, `ga_name`, `ga_car`, `ga_email`, `ga_prie`, `ga_fistPeriod`, `ga_lastPeriod`, `ga_day`, `ga_mont`, `ga_year`) VALUES
	(5, 'sadasddsa', NULL, 'top@top.com', 22222, 2, 2, 5, 9, 2561);
